        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="MJ 绘图 Key" prop="mjKey" label-width="150">
              <el-input v-model="formInline.mjKey" placeholder="请填 MJ 绘图使用的 Key" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="隐藏不需要元素模块" prop="mjHideNotBlock" label-width="150">
              <el-switch v-model="formInline.mjHideNotBlock" active-value="1" inactive-value="0" />
              <el-tooltip class="box-item" effect="dark" placement="right">
                <template #content>
                  <div style="width: 250px">
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="隐藏工作中内容模块" prop="mjHideWorkIn" label-width="150">
              <el-switch v-model="formInline.mjHideWorkIn" active-value="1" inactive-value="0" />
              <el-tooltip class="box-item" effect="dark" placement="right">
                <template #content>
                  <div style="width: 250px">
