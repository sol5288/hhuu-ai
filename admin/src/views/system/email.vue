...
<template>
  <div>
    <page-main>
      <el-alert :closable="false" show-icon title="邮件设置说明"
        description="这里的邮件设置是作用于注册发送的激活邮件、您需要先在服务的env文件中配置邮件服务信息、后续将迁移至此。" type="success" />
    </page-main>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否开启邮箱登录" prop="emailLoginStatus">
              <el-tooltip class="box-item" effect="dark" content="如您启用当前邮箱登录、则用户端可以通过邮箱登录" placement="right">
                <el-switch v-model="formInline.emailLoginStatus" active-value="1" inactive-value="0" />
              </el-tooltip>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否开启邮箱注册" prop="emailRegisterStatus">
              <el-tooltip class="box-item" effect="dark" content="如您启用当前邮箱注册、则用户端可以通过邮箱注册" placement="right">
                <el-switch v-model="formInline.emailRegisterStatus" active-value="1" inactive-value="0" />
              </el-tooltip>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册验证码下发邮件来源" prop="registerVerifyEmailFrom">
              <el-input v-model="formInline.registerVerifyEmailFrom" placeholder="邮件尾部来源 From: (默认： Nine_Ai_Team)"
                clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册时下发邮件详细内容" prop="registerVerifyEmailDesc">
              <el-input v-model="formInline.registerVerifyEmailDesc" type="textarea" :rows="3"
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册账号验证码有效时间" prop="registerVerifyExpir">
              <el-input v-model.number="formInline.registerVerifyExpir" placeholder="注册验证码的有效时间（默认 30 * 60 = 30分钟）"
                clearable>
                <template #append>
                  s
                </template>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册成功通知页团队名称" prop="registerSuccessEmailTeamName">
              <el-input v-model="formInline.registerSuccessEmailTeamName" placeholder="邮件尾部来源 From: (默认： Nine_Ai_Team)"
                clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="通知页邮件详情追加内容" prop="registerSuccessEmaileAppend">
              <el-input v-model="formInline.registerSuccessEmaileAppend" type="textarea" :rows="3"
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册失败通知页团队名称" prop="registerFailEmailTeamName">
              <el-input v-model="formInline.registerFailEmailTeamName" placeholder="邮件尾部来源 From: (默认： Nine_Team_Ai)"
                clearable />
            </el-form-item>
          </el-col>
        </el-row>
