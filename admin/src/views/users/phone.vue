...
<template>
  <div>
    <page-main>
      <el-alert :closable="false" show-icon title="验证码说明"
        description="此处采用阿里云短信服务、请先申请好个人的签名模板以及获取到您的秘钥信息、详细申请地址为：https://dysms.console.aliyun.com/overview 当您配置并开启后则表示开启用户端手机号注册的行为"
        type="warning" />
    </page-main>
          ...
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否开启手机号登录" prop="phoneLoginStatus">
              <el-tooltip class="box-item" effect="dark" content="如您启用短信登录、则用户端则可以通过手机号的方式登录" placement="right">
                <el-switch v-model="formInline.phoneLoginStatus" active-value="1" inactive-value="0" />
              </el-tooltip>
            </el-form-item>
          </el-col>
        </el-row>
          ...
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="是否开启手机号注册" prop="phoneRegisterStatus">
              <el-tooltip class="box-item" effect="dark" content="如您启用短信验证、则用户端则可以通过手机验证码方式注册" placement="right">
                <el-switch v-model="formInline.phoneRegisterStatus" active-value="1" inactive-value="0" />
              </el-tooltip>
            </el-form-item>
          </el-col>
        </el-row>
