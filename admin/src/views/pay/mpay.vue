...
const rules = ref<FormRules>({
  ...
  payMpaySecret: [{ required: true, trigger: 'blur', message: '请填写支付秘钥' }],
  payMpayPid: [{ required: true, trigger: 'blur', message: '请填写商户PID' }],
  payMpayNotifyUrl: [{ required: true, trigger: 'blur', message: '请填写支付通知地址' }],
  payMpayApiPayUrl: [{ required: true, trigger: 'blur', message: '请填写平台支付API请求地址' }],
})
...
async function queryAllconfig() {
  const res = await apiConfig.queryConfig({ keys: ['payMpaySecret', 'payMpayNotifyUrl', 'payMpayReturnUrl', 'payMpayPid', 'payMpayStatus', 'payMpayApiPayUrl', 'payMpayRedirect', 'payMpayChannel'] })
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="支付通知地址" prop="payMpaySecret">
              <el-input v-model="formInline.payMpayNotifyUrl" placeholder="请填写支付通知地址" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="支付回调地址" prop="payMpaySecret">
              <el-input v-model="formInline.payMpayReturnUrl" placeholder="请填写支付成功后的回跳地址" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-divider />
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="支付请求地址" prop="payMpayApiPayUrl">
              <el-input v-model="formInline.payMpayApiPayUrl" placeholder="请填写平台支付请求地址" clearable />
            </el-form-item>
          </el-col>
        </el-row>
