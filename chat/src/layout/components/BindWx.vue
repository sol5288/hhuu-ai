		...
		<div class="p-5 bg-white rounded dark:bg-slate-800">
			...
			<div>
				<div style="white-space: nowrap" class="w-full text-center font-bold text-sm py-5">
					<p>
						请在
						<span class="w-[55px] inline-block text-[red] text-left"
							><NCountdown
								ref="countdownRef"
								:active="activeCount"
								:duration="120 * 1000"
				...
				<div class="my-2 flex justify-center relative">
					<NImage v-if="wxLoginUrl" preview-disabled width="230" :src="wxLoginUrl" />
				...
				<span class="flex items-center justify-center text-base py-5"> 打开微信扫码绑定账户 </span>
			</div>
		</div>
	</NModal>
</template>
