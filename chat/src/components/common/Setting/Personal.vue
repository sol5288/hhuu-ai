	...
	<NSpin :show="loading">
		<div class="p-4 space-y-5 min-h-[200px]">
			...
			<div class="flex items-center space-x-4">
				...
				<div class="w-[200px]">{{ userBalance.usesLeft || '0' }} 积分</div>
			</div>
			<div class="flex items-center space-x-4">
				<span class="flex-shrink-0 w-[100px]">绘画余额</span>
				<div class="w-[200px]">{{ userBalance.paintCount || '0' }} 积分</div>
			</div>
			<div class="flex items-center space-x-4">
				<span class="flex-shrink-0 w-[100px]">MJToken</span>
				<div class="w-[200px]">{{ userBalance.balance || '0' }} Token</div>
			</div>
			<div class="flex items-center space-x-4">
				<span class="flex-shrink-0 w-[100px]">使用金额</span>
				<div class="w-[200px]">{{ userBalance.useTokens || '0' }} Token</div>
			</div>
		</div>
	</NSpin>
</template>
