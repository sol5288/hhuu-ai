...
<template>
	<div class="flex flex-col justify-center items-center">
		<div class="text-2xl text-primary self-start mb-3 flex justify-between w-full">
			<span>Profile</span>
			<NButton v-if="isLogin" tertiary type="error" @click="logOut"> 退出登录 </NButton>
		...
		<div class="self-start">
			...
			<div class="flex items-center space-x-4 pl-3 mt-3">
				...
				<div class="w-[200px]">{{ userBalance.sumModel3Count || '0' }} 积分</div>
			</div>
			<div class="flex items-center space-x-4 pl-3 mt-3">
				<span class="flex-shrink-0 w-24 text-primary">高级模型余额:</span>
				<div class="w-[200px]">{{ userBalance.sumModel4Count || '0' }} 积分</div>
			</div>
			<div class="flex items-center space-x-4 pl-3 mt-3">
				<span class="flex-shrink-0 w-24 text-primary">绘画余额:</span>
				<div class="w-[200px]">{{ userBalance.sumDrawMjCount || '0' }} 积分</div>
			</div>
